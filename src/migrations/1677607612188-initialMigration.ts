...
export class initialMigration1677607612188 implements MigrationInterface {
    name = 'initialMigration1677607612188'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "address" ("id" varchar PRIMARY KEY NOT NULL, "cep" varchar(8) NOT NULL, "state" varchar(24) NOT NULL, "city" varchar(30) NOT NULL, "road" varchar(50) NOT NULL, "number" varchar(10) NOT NULL, "complement" varchar(50) NOT NULL)`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_images" ("id" varchar PRIMARY KEY NOT NULL, "image" varchar(255) NOT NULL, "announcementId" varchar, CONSTRAINT "FK_fac6198a89ec23116ca0352104d" FOREIGN KEY ("announcementId") REFERENCES "announcement" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
