...
export class initialMigration1678200583885 implements MigrationInterface {
    name = 'initialMigration1678200583885'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`INSERT INTO "temporary_user"("id", "name", "email", "password", "cpf", "telephone", "birth_date", "bio", "is_advertiser", "created_at", "updated_at", "resetPasswordToken", "resetPasswordExpires", "address") SELECT "id", "name", "email", "password", "cpf", "telephone", "birth_date", "bio", "is_advertiser", "created_at", "updated_at", "resetPasswordToken", "resetPasswordExpires", "address" FROM "user"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" varchar PRIMARY KEY NOT NULL, "name" varchar(50) NOT NULL, "email" varchar(50) NOT NULL, "password" varchar(60) NOT NULL, "cpf" varchar(11) NOT NULL, "telephone" varchar NOT NULL, "birth_date" varchar NOT NULL, "bio" varchar(255) NOT NULL, "is_advertiser" boolean NOT NULL DEFAULT (0), "created_at" date NOT NULL DEFAULT (datetime('now')), "updated_at" date NOT NULL DEFAULT (datetime('now')), "resetPasswordToken" varchar, "resetPasswordExpires" datetime, "address" varchar, CONSTRAINT "REL_3122b4b8709577da50e89b6898" UNIQUE ("address"))`);
        await queryRunner.query(`INSERT INTO "user"("id", "name", "email", "password", "cpf", "telephone", "birth_date", "bio", "is_advertiser", "created_at", "updated_at", "resetPasswordToken", "resetPasswordExpires", "address") SELECT "id", "name", "email", "password", "cpf", "telephone", "birth_date", "bio", "is_advertiser", "created_at", "updated_at", "resetPasswordToken", "resetPasswordExpires", "address" FROM "temporary_user"`);
