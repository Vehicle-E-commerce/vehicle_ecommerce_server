...
export class initialMigration1677599693909 implements MigrationInterface {
    name = 'initialMigration1677599693909'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "address" ("id" varchar PRIMARY KEY NOT NULL, "cep" integer NOT NULL, "state" varchar(24) NOT NULL, "city" varchar(30) NOT NULL, "road" varchar(50) NOT NULL, "number" varchar(10) NOT NULL, "complement" varchar(50) NOT NULL)`);
